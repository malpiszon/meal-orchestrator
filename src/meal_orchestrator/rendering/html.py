...
.greeting{{max-width:600px;margin:0 auto 12px;background:#f0f8f2;border:1px solid #2f6f4f;
border-radius:8px;padding:14px 16px;font-size:14px;font-weight:bold;color:#1f2933}}
