...
.greeting{{padding:20px 20px 4px;font-size:16px;font-weight:bold;color:#1f2933}}
.sign-off{{padding:16px 20px 4px;font-size:14px;color:#1f2933}}
...
<body>
<div class="card">
<div class="greeting">&#128075; Hi {escape(menu.user_id.capitalize())},</div>
{body}
<div class="sign-off">Enjoy your week! &#127869;</div>
